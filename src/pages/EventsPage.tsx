import { CalendarX2, Eye, KeyRound, Pencil, Plus, ScanLine, Trash2, UserPlus } from 'lucide-react'
...
import { assignUser, createEvent, expectedStudentCount, getEventAudience, listEventAssignments, listEvents, removeAssignment, resetEventPin, setEventStatus, softDeleteEvent, updateEvent, viewEventPin, type EventAssignment, type EventInput } from '../services/events'
